    ...
    <div class="settings-menu">
        ...
        <button id="btn-manage-tags" class="settings-item">
            <div class="settings-info">
                <span class="settings-icon">🏷️</span><span>Gerir Tags</span>
            </div>
        ...
        <button id="btn-manage-units" class="settings-item">
            <div class="settings-info">
                <span class="settings-icon">⚖️</span><span>Gerir Unidades</span>
            </div>
            <div class="settings-arrow">❯</div>
        </button>
        ...
        <button id="btn-manage-areas" class="settings-item">
            <div class="settings-info">
                <span class="settings-icon">🏪</span><span>Gerir Áreas</span>
            </div>
            <div class="settings-arrow">❯</div>
        </button>
