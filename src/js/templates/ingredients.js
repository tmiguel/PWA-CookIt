...
<div class="page-content">
    <div class="form-header">
        ...
        <h2 class="page-title">Gerir Ingredientes</h2>
    </div>

    <div class="card">
        <div class="input-row">
            <input type="text" id="input-code" class="input-field input-code" placeholder="CÓD" maxlength="5">
            <input type="text" id="input-name" class="input-field" placeholder="Nome (ex: Arroz Agulha)">
        </div>
