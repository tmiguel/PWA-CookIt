...
export async function addUnit(code, name) {
...
// NOVA FUNÇÃO: EDITAR
export async function updateUnit(id, code, name) {
    const data = validate(code, name);
    const ref = doc(db, COLLECTION, id);
    await updateDoc(ref, data);
}

export async function deleteUnit(id) { await deleteDoc(doc(db, COLLECTION, id)); }
